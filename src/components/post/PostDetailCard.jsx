...
const PostDetailCard = () => {
          ...
          <div key={index} className="mt-4">
            <div className="flex-shrink-0 border-[1px] border-solid border-gray-300 rounded-[30px] p-6 bg-white">
              ...
              <div className="mt-5">
                ...
                {/* เช็คว่ามีรูปภาพป่าว ถ้ามีให้แสดง */}
  ...
  <div className="mt-4 grid grid-cols-2 gap-4">
    {detail.image.map((img, imgIndex) => (
      <img
        ...
        className="w-full h-full object-cover rounded-[30px] border-[1px] border-solid border-gray-300"
      />
    ))}
  </div>
) : (
  detail.image && (
    <img
      src={detail.image}
      alt="Post Image"
      className="mt-4 w-full h-full object-cover rounded-[30px] border-[1px] border-solid border-gray-300"
    />
  )
)}
